      ...
      body: Container(
        ...
        child: GestureDetector(
          ...
          child: ListView(
            ...
            children: [
              ProfileWidget(
                  imagePath: inputImage != null
                      ? Image.file(inputImage!, width: 128, height: 128)
                      : Image.network(
                          user.imagePath,
                          width: 128,
                          height: 128,
                  ...
                  ElevatedButton(
                    ...
                    onPressed: () {
                      Map<String, dynamic> newUserMap = {
                        ...
                        'cellnumber': cellnumberController.text.isEmpty
                            ? user.cellnumber
                      ...
                      db.editUser(newUserMap, inputImage).then((newUserMapDB) {
